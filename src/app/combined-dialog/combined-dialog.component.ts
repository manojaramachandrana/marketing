...
@Component({
  selector: 'app-combined-dialog',
  templateUrl: './combined-dialog.component.html',
  styleUrls: ['./combined-dialog.component.css']
})
export class CombinedDialogComponent implements OnInit {
  displayedColumns: string[] = ['name', 'email', 'phone','date', 'url'];  


  constructor(
    @Inject(MAT_DIALOG_DATA) public data: { conversionData: any[] },  
    private dialogRef: MatDialogRef<CombinedDialogComponent>
  ) { }
